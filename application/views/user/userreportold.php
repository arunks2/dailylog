  ...
  <body>
   ...
   <table class="table">
        ...
        <?
              ...
              <ul class="ractivity">
                ...
                $cur_date="";$counter=1;$temp=0;
			           foreach($activity as $act)
					       { 
                       // $temp_date=date('Y-m-d', strtotime($act->activity_date));
                          $datetime = explode(" ",$act->activity_date);
                          $date = $datetime[0];
                          //echo $date;
                        if($counter==1)
                        {
          ...
          echo $cur_date;
          $temp=0;
        ?></ul></ul><ul class="ractivity">
        
          <?              
          else:
          //$cur_date=date('Y-m-d', strtotime($act->activity_date));
          ?><div class="report-date"><?  echo date('d-m-Y', strtotime($cur_date)); $temp=1;?></div>
                        <ul class="nolistD">
                        <?endif;
                        if($cur_date===$date):
                             $temp=1;
